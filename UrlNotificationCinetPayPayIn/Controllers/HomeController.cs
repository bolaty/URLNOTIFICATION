...
namespace UrlNotificationCinetPayPayIn.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Index(string cpm_trans_id)
        {
            ...
            string URL_ROOT_ADRESSE_API = ConfigurationManager.AppSettings["URL" + cinqPremiersCaracteres];
                    ...
                    if (data != null)
                    {
                        ...
                        if (data.cpm_result == "00")
                        {
                            ...
                            using (var webClient = new WebClient())
                            {
                                ...
                                String DATEJOURNEE = "";
                                //String AG_CODEAGENCE = AG_CODEAGENCE;
                                String EJ_CODEEPARGNANTJOURNALIER = "";
                                String CT_CODECARTE = "";
                                String NO_CODENATUREVIREMENT = "0017";
                               // String DT_NUMEROTRANSACTION =  data.cpm_trans_id;// CinetPayVerificationStatutResultDatas[0].cpm_trans_id;
                                ...
                                clsObjetEnvoiInfoSouscriptionMobile.AG_CODEAGENCE = AG_CODEAGENCE;
                                ...
                                clsObjetEnvoiInfoSouscriptionMobile.TYPEOPERATION = "02";
                                ...
                                using (var streamReader = new StreamReader(httpResponse1.GetResponseStream()))
                                {
                                    ...
                                    UrlNotificationCinetPayPayIn.Models.clsInfoSouscriptionMobile Resultats = JsonConvert.DeserializeObject<UrlNotificationCinetPayPayIn.Models.clsInfoSouscriptionMobile>(NewISOmsg);
                                    EJ_CODEEPARGNANTJOURNALIER = Resultats.EJ_CODEEPARGNANTJOURNALIER;
                                    CT_CODECARTE = Resultats.CT_CODECARTE;
                                ...
                                ObjetPaiement1 objNF1 = new ObjetPaiement1();

                                objNF1.DATEJOURNEE = DATEJOURNEE;
                                objNF1.AG_CODEAGENCE = AG_CODEAGENCE;
                                objNF1.EJ_CODEEPARGNANTJOURNALIER = EJ_CODEEPARGNANTJOURNALIER;
                                objNF1.CT_CODECARTE = CT_CODECARTE;
                                objNF1.NO_CODENATUREVIREMENT = NO_CODENATUREVIREMENT ;
                                objNF1.DT_NUMEROTRANSACTION = DT_NUMEROTRANSACTION;
                                objNF1.SO_CODESOUSCRIPTION = SO_CODESOUSCRIPTION;
                                objNF1.SM_TELEPHONE = SM_TELEPHONE;
                                objNF1.OP_CODEOPERATEUR = OP_CODEOPERATEUR;
                                objNF1.TK_TOKEN = TK_TOKEN;
                                objNF1.SL_LOGIN = SL_LOGIN;
                                objNF1.SL_MOTDEPASSE = SL_MOTDEPASSE;
                                objNF1.SL_CLESESSION = SL_CLESESSION;
                                objNF1.SL_VERSIONAPK = SL_VERSIONAPK;
                                objNF1.TYPEOPERATION = TYPEOPERATION;
                                objNF1.LG_CODELANGUE = LG_CODELANGUE;
                                objNF1.OS_MACADRESSE = OS_MACADRESSE;
                                ...
                                //objNF.MONTANTOPERATION = MONTANTOPERATION;
                                ...
                                string jsonNF = JsonConvert.SerializeObject(objNF1);

                                var httpWebRequest = (HttpWebRequest)WebRequest.Create(URL_ROOT_ADRESSE_API + "pvgCreationDetailFacture");
                                ...
                                using (var streamReader = new StreamReader(httpResponse.GetResponseStream()))
                                {
                                    ...
                                    string NewISOmsg = responses.Substring(1, responses.Length - 2);
                                    NewISOmsg = NewISOmsg.Replace("\"pvgCreationDetailFactureResult\":", "");
        ...
        //[HttpPost]
        //public ActionResult Index1(string service_id, string gu_transaction_id, string status, string partner_transaction_id, string call_back_url, string commission, string message)
        //{
        //    var culture = new System.Globalization.CultureInfo("fr-FR");
        //    Thread.CurrentThread.CurrentCulture = culture;
        ...
        public class ObjetPaiement1
        {
            public String DATEJOURNEE { get; set; }
            public String AG_CODEAGENCE { get; set; }
            public String EJ_CODEEPARGNANTJOURNALIER { get; set; }
            public String CT_CODECARTE { get; set; }
            public String NO_CODENATUREVIREMENT { get; set; }
            public String DT_NUMEROTRANSACTION { get; set; }
            public String SO_CODESOUSCRIPTION { get; set; }
            public String SM_TELEPHONE { get; set; }
            public String OP_CODEOPERATEUR { get; set; }
            public String TK_TOKEN { get; set; }
            public String SL_LOGIN { get; set; }
            public String SL_MOTDEPASSE { get; set; }
            public String SL_CLESESSION { get; set; }
            public String SL_VERSIONAPK { get; set; }
